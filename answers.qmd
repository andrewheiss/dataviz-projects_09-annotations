...
format:
  ...
  typst:
    ...
    toc: true
    toc-title: Contents
    output-file: PREFIX_09-exercise.pdf
    pdf-standard: ua-1
...
#| fig-height: 4.25
#| fig-alt: |
#|   Scatter chart of 2025 Qatar cars by acceleration and price on a
#|   log-scaled y-axis. Time to reach 100 km/h on the x-axis, price in USD
#|   on the y-axis. Points colored by engine type: electric (red), hybrid
#|   (blue), and petrol (green). A red shaded rectangle highlights the cluster
#|   of fast-accelerating electric vehicles. Annotations call out the $2.2
#|   million Lotus Evija and note that electric cars tend to accelerate
#|   quickly. Faster cars are generally more expensive.
...
#| fig-height: 4.25
#| fig-alt: |
#|   Horizontal jitter strip chart of car prices by country of origin for
#|   cars sold in Qatar in 2025 costing under $200,000. Country of origin on
#|   the y-axis ordered from lowest to highest average price, price in USD on
#|   the x-axis. Each point represents one model, colored by country. Marquee
#|   annotations highlight that all Chinese cars fall under $50,000 and that
#|   German cars show the greatest price variation of any country.
